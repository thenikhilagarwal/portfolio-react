...
const About = () => {
    return (
        <motion.div className="pt-[100px] pb-[50px]">
            <div className="container mx-auto">
                <div className="flex flex-wrap">
                    <motion.div initial={{ opacity: 0, y: 50 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true, amount: 0.2 }}
                        transition={{ duration: 0.6, type: "spring", stiffness: 50 }} className="w-1/2 pe-3" >
                        <div className="p-16 bg-[#06131b] rounded-3xl overflow-hidden relative after:bg-[#139bfd] after:absolute after:h-[474px] after:w-[474px] after:rounded-full after:right-[-150px] after:bottom-[-350px] after:blur-[200px] ">
                            <div className="flex items-center gap-4 mb-8">
                                <h2 className="text-[#139bfd] text-9xl font-bold">08+</h2>
                                <span className="text-white text-5xl/14 font-bold ">Years of<br />Experience</span>
                            </div>
                    ...
                    <motion.div className="w-1/2 ps-3 flex flex-wrap" initial={{ opacity: 0, y: 50 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true, amount: 0.2 }}
                        transition={{ duration: 0.6, delay: 0.2, type: "spring", stiffness: 50 }}>
                        <div className="w-1/2 px-3 mb-5">
                            <div className="tmponhover group bg-[#06131b] shadow-[4px_4px_0_0_rgba(20,155,252,.11)] rounded-3xl text-2xl font-bold text-center p-8 text-white h-full flex flex-col justify-center relative overflow-hidden before:content-[''] before:absolute before:inset-0 before:border before:border-transparent ">
